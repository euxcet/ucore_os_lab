...
struct trapframe temp_k2u, *temp_u2k;
...
trap_dispatch(struct trapframe *tf) {
    ...
    case T_SWITCH_TOU:
		if (tf -> tf_cs != USER_CS) {
			...
			temp_k2u = *tf;
			temp_k2u = *tf;
			temp_k2u.tf_cs = USER_CS;
			temp_k2u.tf_ds = temp_k2u.tf_es = temp_k2u.tf_ss = USER_DS;
			temp_k2u.tf_esp = (uint32_t)tf + sizeof(struct trapframe) - 8;
